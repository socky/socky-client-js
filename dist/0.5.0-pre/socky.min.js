...
Socky.Utils.extend(a,this.generate_subscription_payload());return a},authorize_via_ajax:function(a,b){var c=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP"),d=this.generate_auth_payload();c.open("GET",this._socky.auth_endpoint()+"?payload="+JSON.stringify(d),true);c.setRequestHeader("Content-Type","application/json");c.onreadystatechange=function(){if(c.readyState==4)if(c.status==200){var e=Socky.Utils.parseJSON(c.responseText);a(e)}else b();else b()};c.send(null)},
authorize_via_jsonp:function(a,b){var c=this._name,d=false;Socky.Manager._jsonp_auth_callbacks[c]=function(h){d=true;a(h)};var e=this.generate_auth_payload(),f="Socky.Manager._jsonp_auth_callbacks['"+c+"']";c=this._socky.auth_endpoint();c+="?callback="+encodeURIComponent(f);c+="&payload="+encodeURIComponent(JSON.stringify(e));e=document.createElement("script");e.src=c;c=document.getElementsByTagName("head")[0]||document.documentElement;c.insertBefore(e,c.firstChild);setTimeout(function(){d||b()},
1E4)}});Socky.PresenceChannel=Socky.PrivateChannel.extend({init:function(a,b,c,d){this._super(a,b,c);this._members={};this._subscription_data=d;this.bind("socky:member:added",Socky.Utils.bind(this.on_member_added,this));this.bind("socky:member:removed",Socky.Utils.bind(this.on_member_removed,this))},disconnect:function(){this._members={}},is_presence:function(){return true},acknowledge_subscription:function(a){this._super(a);this._members=a.members},on_member_added:function(a){this._members[a.connection_id]=
