...
Socky.Utils.extend(a,this.generate_subscription_payload());return a},generate_auth_payload_string:function(){var a=[],b=this.generate_auth_payload(),c;for(c in b)a.push(c+"="+encodeURIComponent(b[c]));return a.join("&")},authorize_via_ajax:function(a,b){var c=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");c.open("POST",this._socky.auth_endpoint(),true);c.setRequestHeader("Content-type","application/x-www-form-urlencoded");c.onreadystatechange=function(){if(c.readyState==
4)if(c.status==200){var e=Socky.Utils.parseJSON(c.responseText);a(e)}else b();else b()};var d=this.generate_auth_payload_string();c.send(d)},authorize_via_jsonp:function(a,b){var c=this._name,d=false;Socky.Manager._jsonp_auth_callbacks[c]=function(h){d=true;a(h)};var e=this.generate_auth_payload_string(),f="Socky.Manager._jsonp_auth_callbacks['"+c+"']";c=this._socky.auth_endpoint();c+="?callback="+encodeURIComponent(f);c+="&"+e;e=document.createElement("script");e.src=c;c=document.getElementsByTagName("head")[0]||
document.documentElement;c.insertBefore(e,c.firstChild);setTimeout(function(){d||b()},1E4)}});Socky.PresenceChannel=Socky.PrivateChannel.extend({init:function(a,b,c){this._super(a,b,c);this._members={};this._subscription_data=JSON.stringify(c.data);this.bind("socky:member:added",Socky.Utils.bind(this.on_member_added,this));this.bind("socky:member:removed",Socky.Utils.bind(this.on_member_removed,this))},disconnect:function(){this._members={}},is_presence:function(){return true},acknowledge_subscription:function(a){this._super(a);
this._members=a.members},on_member_added:function(a){this._members[a.connection_id]=a.data;this.trigger("socky:member:added",a.data)},on_member_removed:function(a){var b=this._members[a.connection_id];delete this._members[a.connection_id];this.trigger("socky:member:removed",b)},generate_subscription_payload:function(){var a=this._super();if(this._permissions.hide===true)a.hide=true;a.data=this._subscription_data;return a},members:function(){return this._members}});Socky.Manager={_is_inited:false,
_is_websocket_driver_loaded:false,_jsonp_auth_callbacks:{},_socky_instances:[],_assets_location:"http://js.socky.org/v0.5/assets",_flash_debug:false,_default_options:{debug:false,url:"ws://"+window.location.hostname+":8080/websocket",auth_endpoint:"/socky/auth",auth_transport:"ajax"},is_inited:function(){return this._is_inited},is_driver_loaded:function(){return this._is_websocket_driver_loaded},add_socky_instance:function(a){this._socky_instances.push(a)},default_options:function(){return this._default_options},
set_default_options:function(a){this._default_options=Socky.Utils.extend({},this._default_options,a)},set_assets_location:function(a){this._assets_location=a},set_flash_debug:function(a){this._flash_debug=a},init:function(a){if(!this._is_inited){this._is_inited=true;Socky.Utils.log("inited");a&&this.set_assets_location(a);a=[];var b=Socky.Utils.bind(function(){Socky.Utils.log("Websockets driver loaded");this._web_sockets_loaded()},this);if(window.JSON==undefined){Socky.Utils.log("no JSON support, requiring it");
...
_require_scripts:function(a,b){var c=0,d;d=document.addEventListener?function(g,i){g.addEventListener("load",i,false)}:function(g,i){g.attachEvent("onreadystatechange",function(){if(g.readyState=="loaded"||g.readyState=="complete")i()})};for(var e=Socky.Utils.bind(function(g){c++;if(a.length==c){Socky.Utils.log("All the require script have been loaded!");setTimeout(g,0)}},this),f=Socky.Utils.bind(function(g,i){i=i||function(){};var n=document.getElementsByTagName("head")[0],j=document.createElement("script");
j.setAttribute("src",g);j.setAttribute("type","text/javascript");j.setAttribute("async",true);Socky.Utils.log("Adding script",g);d(j,function(){e(i)});n.appendChild(j)},this),h=0;h<a.length;h++)f(a[h],b)}}})();
